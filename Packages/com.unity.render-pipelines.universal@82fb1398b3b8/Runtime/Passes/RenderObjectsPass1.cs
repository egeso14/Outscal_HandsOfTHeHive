...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class CustomRenderObjectsPass : ScriptableRenderPass
    {
        ...
        public CustomRenderObjectsPass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, uint layerMask, CustomRenderObjects.CustomCameraSettings cameraSettings)            
        {
            profilingSampler = new ProfilingSampler(profilerTag);
            Init(renderPassEvent, shaderTags, renderQueueType, layerMask, cameraSettings);
        }

        internal CustomRenderObjectsPass(URPProfileId profileId, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, uint layerMask, CustomRenderObjects.CustomCameraSettings cameraSettings)
        {
            profilingSampler = ProfilingSampler.Get(profileId);
            Init(renderPassEvent, shaderTags, renderQueueType, layerMask, cameraSettings);
        }

        internal void Init(RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, uint layerMask, CustomRenderObjects.CustomCameraSettings cameraSettings)
        {
            ...
            m_FilteringSettings = new FilteringSettings(renderQueueRange, renderingLayerMask: layerMask);
        ...
        {
            internal CustomRenderObjects.CustomCameraSettings cameraSettings;
